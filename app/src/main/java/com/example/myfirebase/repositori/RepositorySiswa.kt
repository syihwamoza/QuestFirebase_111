...
class FirebaseRepositorySiswa : RepositorySiswa {
    ...
    override suspend fun postDataSiswa(siswa: Siswa) {
        // PERBAIKAN: Satukan logika if-else dan pemanggilan .document() dalam satu baris atau blok yang jelas
        ...
        val data = hashMapOf(
            "id" to (siswa.id.takeIf { it != 0L } ?: docRef.id.hashCode()), // Logika ini opsional, pastikan id unik sesuai kebutuhan
            "nama" to siswa.nama,
